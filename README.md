...
| :smile: [문서희](github.com/seohmoon) | 🙂 [지근](github.com/jg6735) | :smiley: [심재서](https://github.com/simjaeseo) | :laughing: [소정현](github.com/sjhyun7057) | :blush: [김지수](https://github.com/gitjisu) | :wink: [박세은](https://github.com/seniing) |
| :-----------------------------------: | :-------------------------: | :---------------------------------------------: | :----------------------------------------: | :------------------------------------------: | :-----------------------------------------: |
...
|                   **회원 가입**                   |
| :-----------------------------------------------: |
| <img src="README.assets/서비스화면_회원가입.gif"> |
...
|                   **와이어프레임(Figma)**                    |
| :----------------------------------------------------------: |
| ![C104_와이어프레임](README.assets/와이어프레임_ARTREND.PNG) |
